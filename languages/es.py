...
'Edit current dashboard': 'Editar tablero actual',
...
'Package': 'Paquete',
'Package from dashboard': 'Package from dashboard',
...
'The Core': 'El Núcleo',
'The current dashboard is empty': 'El tablero actual esta vacio',
