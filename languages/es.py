...
'in': 'en',
'In this desk': 'En este escritorio',
'includes': 'incluye',
'Index': 'Índice',
...
'Push to': 'Enviar a',
'Push to organization desk': 'Enviar a escritorio',
'Push to other person desk': 'Eviar al escritorio personal de',
...
'Seen': 'Visto',
'Select a person from the list.': 'Selecione el usuario de la lista',
...
'Slugline': 'Slugline',
'Some Content-Type': 'Some Content-Type',
...
'There are no Items on this desk.': 'No hay Items en este escritorio.',
'There are no models': 'No hay modelos',
'There are no modules': 'No hay módulos',
'There are no results.': 'No hay resultados para la busqueda.',
...
'There is no renditions': 'No hay entregas',
...
'This will delete the item and all of his content.': 'Se eliminará el Item y todo el contenido asociado.',
'Ticket': 'Tiquete',
...
'To other person?': '¿Enviar a otra persona?',
...
'You must mark some items first': 'Es necesario marcar algún item primero.',
'You need to mark some items first': 'Es necesario marcar algún item primero.',
