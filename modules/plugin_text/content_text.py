...
class ContentText(ContentPlugin):
    ...
    def define_tables(self):
        ...
        if not hasattr(db, 'plugin_text_text'):
            # definimos la BD
            tbl = db.define_table('plugin_text_text',
    ...
    def create_item_url(self):
        return (URL('plugin_text', 'create.html'),
    ...
    def get_full_text(self, item, CT_REG):
        ...
        output = self.response.render('plugin_text/full_text.txt',
    ...
    def preview(self, item):
        ...
        return XML(self.response.render('plugin_text/preview.html',
